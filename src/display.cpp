...
static lv_res_t ddlistDebugOptionSelectorAction (lv_obj_t* ddlist) {
    ...
    switch(selected_index){
        case 0: 
            //If the first option is selected, it sets selectedDebugOption=0;
            selectedDebugOption=0;
            break;
        case 1:
            //If the second option is selected, it sets selectedDebugOption=1;
            selectedDebugOption=1;
            break;
        case 2:
        //If the third option is selected, it sets selectedDebugOption=2;
...
//Creates the action for when using the btnm/numpad for the PID screen
